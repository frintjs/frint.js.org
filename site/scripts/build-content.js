  ...
  .use(function (files, metalsmith, done) {
    _.each(files, function (obj, file) {
      ...
      if (typeof obj.importContentFromPackage !== 'undefined') {
        ...
        try {
          const packageReadme = fs.readFileSync(config.frintRepoPath + '/packages/' + packageName + '/README.md');
      ...
      if (typeof obj.importContentFromRoot !== 'undefined') {
        ...
        try {
          const rootFileContent = fs.readFileSync(config.frintRepoPath + '/' + rootFile);
