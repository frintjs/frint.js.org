      ...
      <section className="hero is-primary is-large">
        <div className="hero-head">
          <header className="nav">
            ...
            <a aria-label="View source on Github" className="github-corner" href="https://github.com/frintjs/frint">
        ...
        <div className="hero-body">
          <div className="container has-text-centered">
            ...
            <div>
              <a className="button is-primary is-medium" href="/docs">Learn more</a>
              <a className="button is-transparent is-medium" href="http://github.com/frintjs/frint">GitHub</a>
            </div>
          </div>
        </div>
      </section>
